(() => {
  ...
  function injectStyles(){
    ...
    const s=document.createElement('style');s.id='mirsadAuthStyles';s.textContent=`
      ...
      .mirsad-user-balance{padding:8px 10px;margin-bottom:4px;border-bottom:1px solid var(--panel-border);color:var(--gold);font:600 11px var(--font-mono);text-align:right}.mirsad-user-item{display:block;width:100%;padding:9px 10px;border:0;border-radius:8px;background:none;color:var(--text);text-align:right;font:inherit;cursor:pointer}.mirsad-user-item:hover{background:rgba(255,255,255,.06)}
