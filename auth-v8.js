(() => {
  ...
  function playLogoutAnimation(){
    ...
    layer.innerHTML=`<svg viewBox="0 0 1200 120" preserveAspectRatio="none" aria-hidden="true"><path class="mirsad-logout-thread-shadow" d="${path}" pathLength="1"></path><path class="mirsad-logout-thread-main" d="${path}" pathLength="1"></path><circle r="3"><animateMotion dur=".72s" fill="freeze" path="${path}"></animateMotion></circle></svg>`;
    document.body.appendChild(layer);
    return new Promise(resolve=>{window.setTimeout(()=>resolve(layer),720)});
  }
